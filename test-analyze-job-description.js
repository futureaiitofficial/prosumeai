// Test script for the analyze-job-description endpoint
import fetch from 'node-fetch';

async function testAnalyzeJobDescription() {
  try {
    console.log('Testing analyze-job-description endpoint...');
    ...
    console.log('Sending request to analyze-job-description endpoint...');
    const response = await fetch('http://localhost:3000/api/ai/analyze-job-description', {
      method: 'POST',
      headers: {
