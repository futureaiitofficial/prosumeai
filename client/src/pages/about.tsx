...
export default function AboutPage() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen overflow-hidden">
      <Head>
        <title>About ATScribe | AI-Powered Resume Builder for Students</title>
        <meta name="description" content="Learn about ATScribe's mission to provide affordable, AI-powered resume and job application tools for students and early career professionals." />
        <meta name="keywords" content="resume builder, AI resume, job application tools, students, early career, affordable resume tools" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ATScribe.com/about" />
        <meta property="og:title" content="About ATScribe | AI-Powered Resume Builder for Students" />
        <meta property="og:description" content="Learn about ATScribe's mission to provide affordable, AI-powered resume and job application tools for students and early career professionals." />
        ...
        <meta property="twitter:title" content="About ATScribe | AI-Powered Resume Builder for Students" />
        <meta property="twitter:description" content="Learn about ATScribe's mission to provide affordable, AI-powered resume and job application tools for students and early career professionals." />
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-b from-indigo-950 via-indigo-900 to-purple-900 overflow-hidden py-16 md:py-0">
        ...
        <div className="container mx-auto px-4 pt-20 md:pt-0">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-indigo-200 mb-8">
              Empowering students and early career professionals to land their dream jobs with AI-powered tools that make the job search process easier and more effective.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16">
            <span className="text-xs font-semibold uppercase tracking-wider text-indigo-600 mb-2 md:mb-4 inline-block">OUR TEAM</span>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              Meet the People Behind ATScribe
            </h2>
            <p className="text-slate-600">
              Our team is passionate about helping early-career professionals succeed in today's competitive job market by providing accessible, powerful AI tools.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1">Raja Muppidi</h3>
                <p className="text-indigo-600 mb-3">Founder & CEO, Futureaiit</p>
                <p className="text-slate-600 text-sm">
                  A visionary in AI technology who leads Futureaiit with a mission to create innovative solutions. When faced with expensive, ineffective resume tools, Raja developed ATScribe as one of Futureaiit's flagship products to empower students and early career professionals with affordable, cutting-edge tools that deliver real results.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-w-1 aspect-h-1 bg-indigo-100">
                <img 
                  src="/images/team-tech.svg" 
                  alt="Co-founder" 
                  className="w-full h-64 object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1">Sandeep Muppidi</h3>
                <p className="text-indigo-600 mb-3">Co-founder</p>
                <p className="text-slate-600 text-sm">
                  Sandeep provides advisory support for ATScribe, helping to shape the vision and direction of the platform as we continue to grow and evolve.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 py-12 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-base md:text-xl text-indigo-100 mb-8 md:mb-10 max-w-2xl mx-auto">
            Ready to transform your job search experience with AI-powered tools designed specifically for students and early career professionals?
          </p>
